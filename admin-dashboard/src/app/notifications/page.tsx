      ...
      <div className="bg-card rounded-xl border border-border-dark p-6">
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <textarea rows={3} className="w-full bg-card2 border border-border-dark rounded-lg p-3 text-sm text-text-primary focus:outline-none focus:ring-1 focus:ring-brand" placeholder="Notification body text..." />
          </div>
